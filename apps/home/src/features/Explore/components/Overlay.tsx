      ...
      >
        {sections.map((section) => (
          <div
            ...
            className={`${
              section.class
            }-container h-[150vh] pl-2 md:pl-4 flex ${
              section.class === "explore" ? "items-start mt-24" : "items-center"
...
export function Customizer() {
  ...
  return (
    <div className="">
      <div className="fixed top-0 right-0 z-50 flex flex-row items-center gap-2 p-2 text-neutral-900">
        <Button
          size={"icon"}
          variant={"ghost"}
          onClick={() => {
