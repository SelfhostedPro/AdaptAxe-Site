...
import { Links, Socials } from "@/components/Links";
import { SITE_NAME, SITE_HEADLINE } from "@/constants";
...
export function TitleText({ perfSucks }: TextTitleInterface) {
  const { mobile, md, lg } = useBreakpoints();
      ...
      <ScreenSpace depth={5}>
        ...
        <Html fullscreen>
          <div className="w-[100vw] h-[100vh]">
            ...
            <div
              className={cn(
                "absolute top-5 right-5 text-foreground flex flex-row items-center gap-6"
              )}
            >
